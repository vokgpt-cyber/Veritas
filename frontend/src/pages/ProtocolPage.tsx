...
export default function ProtocolPage() {
  ...
  async function downloadProtocol(
    ...
    try {
      ...
      link.href = blobUrl;
      link.download = filename || `protocol.${format === "docx" ? "docx" : format}`;
  ...
  const isAdministrativeProtocol =
    protocol !== null &&
    isWrappedProtocol(protocol) &&
    ...
    <div className="max-w-4xl mx-auto px-6 py-10">
      ...
      {jobId && (
        <div className="mb-8 flex flex-wrap gap-3">
          ...
          {isAdministrativeProtocol && (
            <button
              onClick={() =>
                downloadProtocol(jobId, "actions_docx", "action_list.docx")
              }
