...
const navItems: NavItem[] = [
  ...
  { to: "/developer", labelKey: "nav.developer", icon: SlidersHorizontal, developerOnly: true },
    ...
    () =>
      navItems.filter(
        (item) =>
          ...
          (!item.developerOnly || canUseDeveloper),
      ),
    [canManageUsers, canUseDeveloper],
  );
