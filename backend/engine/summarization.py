...
class SummarizationEngine(BaseEngine):
    ...
    def __init__(self, config: Any) -> None:
        ...
        self._base_url: str = config.summarization.ollama_base_url
    ...
    def unload(self) -> None:
        """Ask Ollama to unload the model from VRAM via keep_alive=0."""
        ...
        try:
            ...
            logger.warning(f"Ollama unload request failed (non-fatal): {e}")
    ...
    async def process(
        ...
        try:
            ...
            if response_format is None or "Ollama HTTP error: 400" not in str(exc):
                raise
            logger.warning(
