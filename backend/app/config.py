...
class SummarizationConfig(BaseSettings):
    ...
    # LLM provider. "ollama" is the current Windows workstation default.
    # "openai_compatible" targets vLLM on the future Ubuntu/RTX 4090 server.
    provider: Literal["ollama", "openai_compatible"] = "ollama"
    ollama_base_url: str = "http://localhost:11434"  # Ollama API base URL
    openai_base_url: str = "http://localhost:8000/v1"  # vLLM OpenAI-compatible API
    openai_api_key: str = ""  # Optional for secured vLLM gateways
