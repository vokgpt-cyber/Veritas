"""FastAPI application entry point for EPAM VERITAS v2.0."""
...
from backend.app.routes import auth, meetings, speakers, system, users
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting EPAM VERITAS v2.0...")
    ...
    audit_log(action=AuditAction.SYSTEM_STARTUP, details={"version": "2.0.0"})
